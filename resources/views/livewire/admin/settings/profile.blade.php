                ...
                <div class="grid grid-cols-2">
                    <div class="pt-4">
                      ...
                      @enderror
                        ...
                        <input type="password" wire:model="password" class="w-3/4 mt-2 shadow-md border-2 py-2 px-2 border-gray-200">
                    </div>
                    ...
                    <div class="pt-4 pl-10">
                      ...
                      @enderror
                        ...
                        <input type="password" wire:model="newpassword" class="w-3/4 mt-2 shadow-md border-2 py-2 px-2 border-gray-200">
                    </div>
                </div>
                <div class="cols-span-2 mr-10 w-full mt-4 mb-4 flex justify-center"> 
                    <button wire:click="upPassword" class="px-2 py-1 mr-16 text-white bg-blue-500 hover:bg-blue-400 mb-2">Update Password</button>
                </div>
            </div>
        </div>
    </div>

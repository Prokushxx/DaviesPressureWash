zx <div>
    <div class="overflow-y-hidden overflow-x-hidden fixed right-0 left-0 top- z-50 justify-center items-center h-modal md:h-full md:inset-0">
        <div class="relative w-full max-w-4xl h-full md:h-auto ">
            <div class="w-screen h-screen flex justify-center items-center ease-in" style="background: rgba(0,0,0,.7)">
                <form wire:submit.prevent="submit"
                    ...
                    <button type="submit" class="bg-blue-500 text-white text-lg py-1 px-2">Add Services</button>
                </form>
            </div>
        </div>
    </div>
